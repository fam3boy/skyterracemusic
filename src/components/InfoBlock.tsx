        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-hyundai-gray-100 border border-hyundai-gray-100">
          ...
          <div className="p-12 space-y-6 group hover:bg-hyundai-gray-50 transition-colors duration-500">
            <div className="flex justify-between items-start">
               <span className="text-[10px] font-black text-hyundai-gold uppercase tracking-[0.3em]">운영 상태</span>
               <Clock className="w-5 h-5 text-hyundai-gray-200 group-hover:text-hyundai-black transition-colors" />
            </div>
            <div className="space-y-2">
               <h4 className="text-2xl font-black text-hyundai-black tracking-tight">오늘의 운영 시간</h4>
            ...
            <div className="pt-2 flex items-center gap-2">
               ...
               <span className="text-[11px] font-black text-hyundai-emerald uppercase tracking-widest">실시간 방송 중</span>
            </div>
          </div>
          ...
          <div className="p-12 space-y-6 group hover:bg-hyundai-gray-50 transition-colors duration-500">
            <div className="flex justify-between items-start">
               <span className="text-[10px] font-black text-hyundai-gold uppercase tracking-[0.3em]">신청 가이드라인</span>
               <Headphones className="w-5 h-5 text-hyundai-gray-200 group-hover:text-hyundai-black transition-colors" />
            </div>
            <div className="space-y-2">
               <h4 className="text-2xl font-black text-hyundai-black tracking-tight">선곡 정책 안내</h4>
               <p className="text-[13px] font-medium text-hyundai-gray-500 leading-relaxed">
          ...
          <div className="p-12 space-y-6 group hover:bg-hyundai-gray-50 transition-colors duration-500">
            <div className="flex justify-between items-start">
               <span className="text-[10px] font-black text-hyundai-gold uppercase tracking-[0.3em]">테라스 공간</span>
               <MapPin className="w-5 h-5 text-hyundai-gray-200 group-hover:text-hyundai-black transition-colors" />
            </div>
            <div className="space-y-2">
               <h4 className="text-2xl font-black text-hyundai-black tracking-tight">위치 안내</h4>
               <p className="text-[13px] font-medium text-hyundai-gray-500 leading-relaxed">
                 현대프리미엄아울렛 대전점 3F <br />
                 하늘정원 스카이테라스 메인홀
               </p>
