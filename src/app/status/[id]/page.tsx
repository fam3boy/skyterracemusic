...
export default function StatusDetailPage() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[80vh] gap-6">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-hyundai-gray-400">Authenticating Data Access</p>
      </div>
    );
  }
    ...
    return (
      <div className="portal-container py-40 text-center space-y-12">
        ...
        <div className="space-y-4">
           <h2 className="text-4xl md:text-6xl font-black text-hyundai-black uppercase tracking-tighter">Request Null Reference</h2>
  ...
  const statusMap = {
    pending: { 
      ...
      subLabel: 'Evaluation in Progress'
    },
    approved: { 
      label: 'TRANSMISSION_READY', 
      icon: Verified, 
      color: 'bg-hyundai-emerald', 
      text: '디지털 선곡 검증이 완료되었습니다. 이번 주 목요일 19:00 이후 정규 플레이리스트에 정식 편성됩니다.',
      subLabel: 'Approved for Broadcast'
    },
    hold: { 
      label: 'AUDIT_HOLD', 
      icon: ShieldCheck, 
    ...
    <div className="bg-white min-h-screen pb-40">
      ...
      <div className="border-b border-hyundai-gray-100 bg-white">
        <div className="portal-container">
           <div className="h-14 flex items-center gap-4 text-[10px] font-black text-hyundai-gray-400 uppercase tracking-widest">
              ...
              <Link href="/status" className="hover:text-hyundai-black transition-colors">Inquiry Center</Link>
              <span className="w-1.5 h-px bg-hyundai-gray-200"></span>
              <span className="text-hyundai-black">Detailed Report</span>
           </div>
        </div>
      </div>
      ...
      <div className="portal-container pt-24 md:pt-32">
        ...
        {isNew && (
           <div className="mb-24 bg-hyundai-emerald p-12 text-white flex flex-col md:flex-row items-center gap-10 animate-in fade-in slide-in-from-top-8 duration-1000 shadow-3xl shadow-hyundai-emerald/20">
              ...
              <div className="space-y-2 flex-grow text-center md:text-left">
                 <h2 className="text-3xl font-black uppercase tracking-tight">System Registration Successful</h2>
              ...
              >
                {copied ? 'COPIED_ID' : 'COPY_UNIQUE_ID'}
              </button>
           </div>
        )}
        ...
        <div className="max-w-6xl mx-auto space-y-32">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-hyundai-gray-100 border border-hyundai-gray-100">
              <div className={cn("lg:col-span-4 p-12 text-white flex flex-col justify-between gap-12", status.color)}>
                 <div className="space-y-4">
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-60">Operations Status</span>
              ...
              <div className="lg:col-span-8 bg-white p-12 flex flex-col justify-center space-y-8">
                 <div className="space-y-4">
                    <span className="text-[10px] font-black text-hyundai-gold uppercase tracking-[0.4em]">Official Response</span>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 pt-24 border-t-2 border-hyundai-gray-100">
              ...
              <div className="space-y-16">
                 <div className="space-y-4">
                    <span className="text-3xl font-black text-hyundai-gray-200 uppercase tracking-tighter block italic">01/Track Specs</span>
                    <h3 className="text-3xl font-black text-hyundai-black uppercase tracking-tight">Audio Asset Identification</h3>
                 </div>
                 ...
                 <div className="space-y-12">
                    ...
                    <div className="space-y-8">
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-[11px] font-black text-hyundai-gray-400 uppercase tracking-[0.3em]">Customer Narrative Data</span>
                       </div>
                       <div className="p-10 bg-hyundai-gray-50 border border-hyundai-gray-100 relative">
                          <p className="text-lg font-medium text-hyundai-gray-500 leading-relaxed italic">
                             "{request.story || 'NO_STORY_DATA_PROVIDED'}"
                          </p>
                       </div>
                    </div>
                 </div>
              ...
              <div className="space-y-16">
                 <div className="space-y-4">
                    <span className="text-3xl font-black text-hyundai-gray-200 uppercase tracking-tighter block italic">02/Registry Meta</span>
                    <h3 className="text-3xl font-black text-hyundai-black uppercase tracking-tight">Transaction Log Details</h3>
                 </div>

                 <div className="space-y-6 divide-y-2 divide-hyundai-gray-50">
                    {[
                      { icon: Hash, label: 'Audit ID', val: request.id, mono: true, copy: true },
                      { icon: Calendar, label: 'Entry Date', val: new Date(request.created_at).toLocaleString() },
                      { icon: User, label: 'Lead Alias', val: request.requester_name || 'SYSTEM_ANONYMOUS', upper: true },
                      { icon: Heart, label: 'External Source', val: request.youtube_url ? 'YOUTUBE_VERIFIED' : 'MANUAL_ENTRY', link: request.youtube_url }
                    ].map((item, i) => (
